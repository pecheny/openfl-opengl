...
//abstract WebGLRenderContext(lime.graphics.WebGL2RenderContext) {
abstract WebGLRenderContext(Dynamic) {
	...
	public inline function compressedTexSubImage2D (target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, srcData: ArrayBufferView):Void {
